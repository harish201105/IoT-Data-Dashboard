...
const SignalChart: React.FC<SignalChartProps> = ({ 
  ...
  const renderChart = () => {
    ...
    // Baseline reference for signal interpretation
    const referenceLines = [
      <ReferenceLine y={50} stroke="#f59e0b" strokeDasharray="3 3" label={{ value: 'Yellow Signal', position: 'insideBottomRight', fill: '#f59e0b', fontSize: 12 }} />,
      <ReferenceLine y={100} stroke="#ef4444" strokeDasharray="3 3" label={{ value: 'Red Signal', position: 'insideTopRight', fill: '#ef4444', fontSize: 12 }} />
    ];
